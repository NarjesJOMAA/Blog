        ...
        <body>
            <header>
                <nav class="navbar navbar-expand-lg navbar-light bg-light">
                    ...
                    <img src="https://www.icone-png.com/png/15/15224.png" width="35" height="35" title="" alt=""></a>
                    ...
                    <div class="collapse navbar-collapse" id="navbarLinks">
                        ...
                        <li class="nav-item">
                            ...
                            <li class="nav-item">
                                <a class="nav-link text-center bg-light" href="./session.php">Compte utilisateur</a>
                            </li>
                        </ul>
                    </div>
                </nav>
